  ...
  return (
    <div className="fixed top-0 left-0 flex items-center justify-center w-screen h-screen fadein z-9999">
      <div
        ...
        } bg-opacity-95 m-5 flex flex-col min-w-[350px] sm:w-fit lg:max-w-[50%] text-center h-fit max-h-[90%] shadow-lg shadow-black/30 z-100 rounded-xl p-4`}
      >
        <div className="flex justify-end w-full text-[25px]">
          <AiFillCloseCircle
            ...
            } transition-all duration-300 cursor-pointer shadow-md shadow-black/30`}
          />
        </div>
          ...
          {buttonIs && (
            <div className="flex justify-around w-full mt-6 text-white">
              <button
                ...
                className="px-4 py-2 font-semibold transition-all duration-300 border rounded-md shadow-md border-green-700/30 shadow-black/30 hover:bg-green-700 bg-green-green1"
              >
              ...
              {refuseButtonPlaceholder != "disabled" && (
                <button
                  onClick={close}
                  className="px-4 py-2 transition-all duration-300 border rounded-md shadow-md border-red-700/30 shadow-black/30 hover:bg-red-700 bg-red-red1"
                >
